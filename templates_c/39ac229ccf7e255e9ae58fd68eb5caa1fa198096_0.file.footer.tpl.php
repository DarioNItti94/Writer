...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6138f734641d26_83288518',
...
function content_6138f734641d26_83288518 (Smarty_Internal_Template $_smarty_tpl) {
?><footer>
            ...
            <div class="row">
                ...
                <div class="col-md-2 hidden-sm">
                    <div class="single-footer">
                        ...
                        <ul class="footer-list">
                            <li><a href="my-account.tpl">My Account</a></li>
...
<?php echo '<script'; ?>
 src="js/vendor/jquery-1.12.0.min.js"><?php echo '</script'; ?>
>
<!-- bootstrap js -->
<?php echo '<script'; ?>
...
<!-- jquery countdown js -->
<?php echo '<script'; ?>
 type="text/javascript" src="venobox/venobox.min.js"><?php echo '</script'; ?>
>
<!-- jquery Meanmenu js -->
<?php echo '<script'; ?>
...
<!-- Nivo slider js -->
<?php echo '<script'; ?>
 src="lib/js/jquery.nivo.slider.js" type="text/javascript"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="lib/home.js" type="text/javascript"><?php echo '</script'; ?>
>
<!-- main js -->
<?php echo '<script'; ?>
